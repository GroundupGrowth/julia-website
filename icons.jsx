...
const ThreadMotif = ({ width = 320, height = 120, stroke = "currentColor" }) => (
...
const RingsMotif = ({ size = 160, stroke = "currentColor" }) => (
...
Object.assign(window, { Ico, ThreadMotif, RingsMotif });
